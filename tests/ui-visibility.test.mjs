...
/* ---- version stamp ---- */
check('app version is stamped in the markup', /name="app-version" content="2\.0\.3"/.test(html), true);
check('app version is stamped in app.js', /APP_VERSION = '2\.0\.3'/.test(appjs), true);
